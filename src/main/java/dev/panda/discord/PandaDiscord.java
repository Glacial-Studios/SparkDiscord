package dev.panda.discord;

import dev.panda.discord.events.*;
...
@Getter @Setter
public class PandaDiscord extends JavaPlugin {
    ...
    public static PandaDiscord get() {
        return getPlugin(PandaDiscord.class);
    }
}